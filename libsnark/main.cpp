    ...
    const char* output_path)
{
    ...
    printf("X:%s\n", evaluation_At.coord[0].toString(16).c_str());
    printf("Y:%s\n", evaluation_At.coord[1].toString(16).c_str());
    printf("Z:%s\n", evaluation_At.coord[2].toString(16).c_str());
...
int main(int argc, const char * argv[])
{
  ...
  if (mode == "compute") {
      ...
      if (curve == "MNT4753") {
          run_preprocess<bn128_pp>(params_path, "MNT4753_preprocessed");
      } else if (curve == "MNT6753") {
